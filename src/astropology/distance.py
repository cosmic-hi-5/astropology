...
def bottleneck_distance(diagram_i, diagram_j, matching: bool = False) -> float:
    ...
    distance = bottleneck(dgm1=diagram_i, dgm2=diagram_j, matching=matching)
...
def wasserstein_distance(
    ...
    distance = wasserstein(dgm1=diagram_i, dgm2=diagram_j, matching=matching)
